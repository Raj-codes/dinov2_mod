...
def main():
    ...
    create_image_tiles(image= cropped_image, input_file, output_folder, tile_size)
    ...
    dataset = ImageDataset(test_image_paths=test_image_paths, transform=transform)
    ...
    results = predict_labels(predict_model_path, label_map_path, test_feats=all_features, test_image_paths=test_image_paths, output_file="output.json")
    print("Completed..")
